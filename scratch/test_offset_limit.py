...
print("--- Testing offset/limit ---")
test_users_orders({"pair": "XRPMYR", "offset": 0, "limit": 10})
test_users_orders({"pair": "XRPMYR", "offset": "0", "limit": "10"})
test_users_orders({"pair": "XRPMYR", "offset": 0, "limit": 10, "status": "active"})
test_users_orders({"pair_name": "XRPMYR", "offset": 0, "limit": 10})
test_users_orders({"pair_name": "XRPMYR", "offset": "0", "limit": "10"})
