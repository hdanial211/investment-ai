...
echo [3/4] Menghidupkan Enjin Pasukan Elit (Multi-Coin Unified Bot)...
start "Multi-Coin Live Bot" cmd /k "cd /d "%~dp0" && backend\venv\Scripts\python backend\live_engine.py"
